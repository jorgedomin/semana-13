...
class AplicacionGUI:
    def __init__(self, root):
        ...
        self.root.geometry("300x300")  # Ajusta el tamaño de la ventana a 900x900
        ...
        self.archivo_menu.add_command(label="Limpiar o Borar", command=self.limpiar)
        ...
        self.boton_limpiar = tk.Button(root, text="Limpiar o Borar", command=self.limpiar)
